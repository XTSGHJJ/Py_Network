...
def netmiko_dev_connect(ip,username,passwd,check_comm,dev_type,back_file):
    dev = {'device_type':dev_type,'ip':ip,'username':username,'password':passwd}
    # try:
...
def dev_judge(DeviceBrand):
    ...
    #Huawei
    if dev_value == 'huawei':
        hw_comm = 'C:/Users/Chen/Desktop/net-inspection2.0/devInfo_file/hw_comm.txt'
        hw_bac_path = 'C:/Users/Chen/Desktop/net-inspection2.0/backup_file/hw_bac_file/' #backup路径最后要加/，否则文件无法创建成功
        return ['huawei',hw_comm,hw_bac_path]
    #New H3C
    elif dev_value == 'h3c':
        h3c_comm = 'C:/Users/Chen/Desktop/net-inspection2.0/devInfo_file/h3c_comm.txt'
        h3c_bac_path = 'C:/Users/Chen/Desktop/net-inspection2.0/backup_file/h3c_bac_file/'
        return ['hp_comware',h3c_comm,h3c_bac_path]
    #Fortinet
    elif dev_value == 'forigate':
        ft_comm = 'C:/Users/Chen/Desktop/net-inspection2.0/devInfo_file/ft_comm.txt'
        ft_bac_path = 'C:/Users/Chen/Desktop/net-inspection2.0/backup_file/ft_bac_file/'
        return ['fortinet',ft_comm,ft_bac_path]
    #Cisco
    elif dev_value == 'cisco':
        cisco_comm = 'C:/Users/Chen/Desktop/net-inspection2.0/devInfo_file/cisco_comm.txt'
        cisco_bac_path = 'C:/Users/Chen/Desktop/net-inspection2.0/backup_file/cisco_bac_file/'
        return ['cisco_ios',cisco_comm,cisco_bac_path]
    #Hillstone
    elif dev_value == 'hillstone':
        sg_comm = 'C:/Users/Chen/Desktop/net-inspection2.0/devInfo_file/sg_comm.txt'
        sg_bac_path = 'C:/Users/Chen/Desktop/net-inspection2.0/backup_file/sg_bac_file/'
